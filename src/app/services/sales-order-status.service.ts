...
export class SalesOrderStatusService {
  ...
  getPagedAdvanced(body: DTParameters): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${this.base}/sales-order-status/paged-advanced`, body);
  }

  /** Chi tiết trạng thái đơn bán theo ID */
  getById(id: number): Observable<ApiResponse<SalesOrderStatusDetailDto>> {
    return this.http.get<ApiResponse<SalesOrderStatusDetailDto>>(`${this.base}/sales-order-status/${id}`);
  }

  /** Tạo mới trạng thái đơn bán */
  create(payload: CreateSalesOrderStatusDto): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${this.base}/sales-order-status`, payload);
  }

  /** Cập nhật trạng thái đơn bán */
  update(payload: UpdateSalesOrderStatusDto): Observable<ApiResponse<any>> {
    return this.http.put<ApiResponse<any>>(`${this.base}/sales-order-status`, payload);
  }

  /** Xóa trạng thái đơn bán theo ID */
  delete(id: number): Observable<ApiResponse<any>> {
    return this.http.delete<ApiResponse<any>>(`${this.base}/sales-order-status/${id}`);
  }
