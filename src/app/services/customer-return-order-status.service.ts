...
export class CustomerReturnOrderStatusService {
  ...
  getPagedAdvanced(body: DTParameters): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${this.base}/customer-return-order-status/paged-advanced`, body);
  }

  /** Chi tiết trạng thái đơn hoàn khách theo ID */
  getById(id: number): Observable<ApiResponse<CustomerReturnOrderStatusDetailDto>> {
    return this.http.get<ApiResponse<CustomerReturnOrderStatusDetailDto>>(`${this.base}/customer-return-order-status/${id}`);
  }

  /** Tạo mới trạng thái đơn hoàn khách */
  create(payload: CreateCustomerReturnOrderStatusDto): Observable<ApiResponse<any>> {
    return this.http.post<ApiResponse<any>>(`${this.base}/customer-return-order-status`, payload);
  }

  /** Cập nhật trạng thái đơn hoàn khách */
  update(payload: UpdateCustomerReturnOrderStatusDto): Observable<ApiResponse<any>> {
    return this.http.put<ApiResponse<any>>(`${this.base}/customer-return-order-status`, payload);
  }

  /** Xóa trạng thái đơn hoàn khách theo ID */
  delete(id: number): Observable<ApiResponse<any>> {
    return this.http.delete<ApiResponse<any>>(`${this.base}/customer-return-order-status/${id}`);
  }
